...
<head>
    ...
    <title>Activity 1 9-4-2025</title>
    <style>
        body {
            background:  #416677;
        ...
        .home {
            background: url('https://images.pexels.com/photos/943096/pexels-photo-943096.jpeg') no-repeat center center / cover;
            height: 50vh;
            display: flex;
            align-items: center;
            justify-content: center;
            color: white;
            text-shadow: 2px 2px 4px rgba(3, 3, 3, 0.855);
            opacity: 0.8;
        }
        .container {
            max-width: 1200px;
